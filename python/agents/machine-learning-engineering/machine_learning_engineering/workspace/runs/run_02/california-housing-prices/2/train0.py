...
# --- Initialize and Train XGBoost Model (from Reference Solution) ---
...
# Ensemble the predictions by taking a simple average
# This creates a combined prediction from both models
